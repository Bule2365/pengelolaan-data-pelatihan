            ...
            <table class="w-full min-w-[600px] bg-white border-collapse">
                <thead class="bg-blue-50 text-blue-800">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs md:text-sm lg:text-base">Nama Kategori</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @foreach ($categories as $category)
                        <tr class="hover:bg-gray-50 transition-colors duration-300">
                            <td class="px-4 py-4 text-xs md:text-sm lg:text-base">{{ $number++ }}</td>
                            <td class="px-4 py-4 text-xs md:text-sm lg:text-base">{{ $category->category_name }}</td>
                            <td class="px-4 py-4 flex space-x-2 md:space-x-4">
                                ...
                                <button onclick="openModal('delete-confirmation-modal-{{ $category->id }}')"
                            ...
                            <div id="delete-confirmation-modal-{{ $category->id }}"
                                ...
                                <div
                                    ...
                                    <div class="mt-4 flex space-x-4">
                                        ...
                                        <button onclick="closeModal('delete-confirmation-modal-{{ $category->id }}')"
