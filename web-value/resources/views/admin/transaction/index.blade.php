            ...
            <table class="w-full min-w-[600px] bg-white border-collapse">
                <thead class="bg-blue-50 text-blue-800">
                    <tr class="bg-gray-200">
                        <th class="px-4 py-2 text-left text-xs md:text-sm lg:text-base">#</th>
                        <th class="px-4 py-2 text-left text-xs md:text-sm lg:text-base">Nama Metode</th>
                        <th class="px-4 py-2 text-left text-xs md:text-sm lg:text-base">Nomor</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($methods as $method)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-4 text-xs md:text-sm lg:text-base">{{ $method->method_name }}</td>
                            <td class="px-4 py-4 text-xs md:text-sm lg:text-base">{{ $method->no }}</td>
                            <td class="px-4 py-4 text-xs md:text-sm lg:text-base">
                                <button onclick="openModal('delete-confirmation-modal-{{ $method->id }}')"
                            ...
                            <div id="delete-confirmation-modal-{{ $method->id }}"
                                ...
                                <div
                                    ...
                                    <p class="mt-2 text-gray-700">Apakah Anda yakin ingin menghapus kategori ini?</p>
                                    <div class="mt-4 flex space-x-4">
                                        ...
                                        <button onclick="closeModal('delete-confirmation-modal-{{ $method->id }}')"
